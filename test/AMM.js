...
describe("AMM", () => {
  ...
  describe("swapping tokens", () => {
    ...
    it("facilitates swaps", async () => {
      ...
      console.log(
        `investor 1 token2 balance before swap: ${ethers.utils.formatEther(
          balance
        )}\n`
      );
      ...
      balance = await token2.balanceOf(investor1.address);
      console.log(
        `investor1 token2 balance after sawp: ${ethers.utils.formatEther(
          balance
        )} \n`
      );
      ...
      console.log(
        `investor 2 token1 balance before swap: ${ethers.utils.formatEther(
          balance
        )}\n`
      );
      ...
      balance = await token1.balanceOf(investor2.address);
      console.log(
        `investor 2 token1 balance after swap: ${ethers.utils.formatEther(
          balance
        )}\n`
      );
      expect(estimate).to.equal(balance);
